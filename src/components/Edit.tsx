...
//                             <h1 className="text-center">Edit Address</h1>
...
//                                     />
//                                     <NavLink to={"/profile"}>
//                                         <button className={"btn btn-danger w-100 text-uppercase"}>
//                                             Submit  </button>
//                                     </NavLink>
//                                 </form>
//                             </div>
...
class Edit extends React.Component<RegisterProps> {
    state: RegisterState = { address1: "", address2: "", city: "", state1: "", pincode: '' };
...
export default connect(mapStoreDataToProps, mapDispatchToProps)(Edit);
